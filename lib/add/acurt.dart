...
class Acurt extends StatefulWidget {
  @override
  _AcurtState createState() => _AcurtState();
}

class _AcurtState extends State<Acurt> {
                ...
                onPressed: () async {
                  if( _formKey.currentState.validate() ){
                    ...
                    if( response.documents.length >= 1000 ){
                      ...
                      Firestore.instance.collection('acurt').document() .setData(map).then(( onValue ){
                      });
                      setState(() {
                        isLoading = false;
                        isError = false;
